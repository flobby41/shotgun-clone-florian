      ...
      <div className="mb-6">
        ...
        <div className="flex gap-2 overflow-x-auto pb-2">
          <Button
            ...
            size="sm"
            onClick={() => setFilter('')}
            className={filter === '' ? 'bg-violet-600 hover:bg-violet-700' : 'border-gray-600 text-gray-300 hover:text-white'}
          >
            All Events
          </Button>
          <Button
            ...
            className={filter === 'today' ? 'bg-violet-600 hover:bg-violet-700' : 'border-gray-600 text-gray-300 hover:text-white'}
          >
          ...
          <Button
            ...
            className={filter === 'weekend' ? 'bg-violet-600 hover:bg-violet-700' : 'border-gray-600 text-gray-300 hover:text-white'}
          >
